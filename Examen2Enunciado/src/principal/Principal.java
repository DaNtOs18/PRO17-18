...
public class Principal {
	...
	public static void main(String[] args) {
		...
		String[] nifs = { "11223344M", "44332211L", "12345678P", "44747158Z", "87654321L" };
		boolean[] validos = md.metodo1(nifs);
		String[] lista = { "2@CITROEN@C4@16.25", "t@RENAULT@CLIO@5.50", "7@TOYOTA@AURIS@16.X",
				"5@VOLKWAGEN@TUAREG@18.50" };
		Vehiculo[] listaCoches = md.metodo2(lista);
		int[][] resul= md.metodo3(4, 3);
