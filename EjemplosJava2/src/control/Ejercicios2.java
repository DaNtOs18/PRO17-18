...
public class Ejercicios2 {
	...
	public ArrayList<HashMap<String, String>> creaDatos(String[] claves, String[] valores) {
		...
		for (int i = 0; i < claves.length; i++) {
			registro.put(claves[i], valores[i]);
		}
		HashMap<String, String> m = resultado.get(0);
		int j = 0;
		for (String current : m.keySet()) {
			System.out.println("Clave: " + claves[j] + " Valor: " + valores[j]);
			j++;
		}
		return resultado;
	}

	public static ArrayList<HashMap<String, String>> creaDatos2(String[] claves, String[] valores) {
		ArrayList<HashMap<String, String>> resultado = new ArrayList<HashMap<String, String>>();
	...
	public static ArrayList<HashMap<Integer, Integer>> creaDatos3(String[] islas, int[][] visitantes) {
		...
		for (int i = 0; i < islas.length; i++) {
			...
			for (int j = 0; j < visitantes[i].length; j++) {
				hm.put(j, visitantes[i][j]);
			}
			resultado.add(hm);
			HashMap<Integer, Integer> map = resultado.get(0);
			for (HashMap<Integer, Integer> hashMap : resultado) {
				 ...
				 * int k = 0;
				 * 
				 * for (Integer val : map.values()) { System.out.println("Visitantes " + val);
				 * k++;
				 */
			}
		return resultado;
