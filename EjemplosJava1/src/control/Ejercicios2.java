...
public class Ejercicios2 {
	public static void main(String[] args) {
		...
		ArrayList<Vehiculo> listaVe = ej.crearListaVehiculos("ficheros/vehiculos.txt");
		ej.listaVehiculos(listaVe);
		System.out.println("Fin");
	}

	public ArrayList<Vehiculo> crearListaVehiculos(String rutaFicheroVehiculos) {
		...
		try {
			...
			while ((linea = br.readLine()) != null) {
				...
				String[] fechaCadena = campos[5].split("-");
	...
	public void listaVehiculos(ArrayList<Vehiculo> listaVehiculos) {
		Ejercicios2 m1 = new Ejercicios2();
		ArrayList<Vehiculo> lista = new ArrayList<Vehiculo>(m1.crearListaVehiculos("ficheros/vehiculos.txt"));
