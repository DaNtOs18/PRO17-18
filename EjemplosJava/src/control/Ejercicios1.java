...
public class Ejercicios1 {
	...
	//Ejercicio1
	ArrayList<Movimiento> ListadoMovimientos = ej2.examenCargaMovimientos("ficheros/movimientos.txt");
	
	//Ejercicio2
	float[][] movimientos = {{1.5f,1.5f},{3.5f},{3.5f,2.0f}}; 
	float saldoInicial = 5000.0f;
	float saldoFinal = ej2.examenCalculaSaldo(movimientos, saldoInicial);
	System.out.println("\nEJERCICIO2:\nSaldo Final: " + saldoFinal);
	
	//Ejercicio3
	float[][] listadoNumVisitantes = ej2.leerTuristasTxt("ficheros/TuristasIsla2016.txt");
	ej2.totalVisitantesPorMeses(listadoNumVisitantes);
}
