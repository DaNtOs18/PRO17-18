...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// practicas.leerFicheroTextoOrdenado("ficheros/estudiantesGrupo.txt");
		// practicas.copiaEstudiantestxtAObjetos("ficheros/estudiantes.txt",
		// "ficheros/estudiantes.obj");
		// practicas.copiaEstudiantesObjATexto("ficheros/estudiantes.obj",
		// "ficheros/estudiantes1.txt");
		// String[] ca = practicas.leerCa("ficheros/comunidades.txt");
		 //HashMap<String, ArrayList<String>> datosListado =
		 //practicas.generarDatosListado("ficheros/provincias.txt");
		 //practicas.listadoProvinciasPorCA(datosListado);
		// ad.conexion("localhost","tienda","root","");

		AccesoDatos ad = new AccesoDatos();
		// String sql = "SELECT * FROM " + tabla;
		// ad.getAllRecords("localhost", "jonathan", "Jonathan", "qwerty", "books");
		// ad.connect();
		//practicas.leerTeclado();
		//practicas.menu();
		//ad.consultaPadronCAProvincias();
		//practicas.validarNif("44747158Z");
